...
import {get_parent_by_class,create_element,divs,get_parent_by_classes,update_class_name,update_child_html,type Component} from './dom_utils.js'
import {
  type TreeNode,
...
export class TreeControl implements Component{
