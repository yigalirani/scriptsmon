...
function make_channel_states() {
  return {
    stdout: { parser_state: void 0, style: clear_style },
    stderr: { parser_state: void 0, style: clear_style }
  };
}
