...
var other_ansi = or(
  ...
  // Standard CSI (Cursor, etc)
  r`\x1b\][^\x1b\x07]*`,
  // Any other OSC
  r`\x1b[\x40-\x5a\x5c\x5e\x5f]`,
  // Fe Escape sequences
  r`\x1b.`,
  // 2-character sequences
  r`[\x00-\x1f]`
  // Control chars (Tab, CR, LF, etc)
);
var ansi_regex = make_re("g")(
  or(
    hyperlink,
    sgr_color,
    other_ansi
