...
var Terminals = class {
  ...
  command_find() {
    const find_widget = document.body.querySelector('.terms_container .term_panel[style*="display: flex"] .find_widget_container');
    find_widget?.classList.remove("hidden");
    find_widget?.querySelector(".find_input_field")?.focus();
  }
  set_selected(id) {
