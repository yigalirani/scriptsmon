...
var RegExpSearcher = class {
  constructor(index, regex, highlight) {
    this.index = index;
    this.regex = regex;
  ...
  iter = () => {
    while (true) {
      ...
      const start2 = this.advance_head(match.index);
      const end = this.advance_head(match.index + match[0].length);
      const range = new Range();
      range.setStart(start2.node, start2.pos);
...
var TerminalSearch = class {
  constructor(term_el, term_text, highlight) {
