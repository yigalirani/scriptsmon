...
<svg class=error width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="red">
    <!-- Circle -->
    <path d="M8 1C4.14 1 1 4.14 1 8C1 11.86 4.14 15 8 15C11.86 15 15 11.86 15 8C15 4.14 11.86 1 8 1ZM8 14C4.691 14 2 11.309 2 8C2 4.691 4.691 2 8 2C11.309 2 14 4.691 14 8C14 11.309 11.309 14 8 14Z"/>
