...
function link_to_replacemnt(link) {
  ...
  const close = `</p>`;
  return { open, close, start: start2, end };
}
...
var TerminalPanel = class {
  ...
  line_to_html = (x) => {
    ...
    const { replacements, ancore } = parse3(stripped_text, this.ancore);
    this.ancore = ancore;
