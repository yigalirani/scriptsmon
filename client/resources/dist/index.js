...
var NodeIndex = class {
  ...
  find_node_index_binary(target_index) {
    let low = 0;
  ...
  get_ranges(offsets) {
    const ans = [];
    for (const { start: start2, end } of offsets) {
      const start_node_idx = this.find_node_index_binary(start2);
      const start_node = this.text_nodes[start_node_idx];
      const start_offset = start2 - this.node_offsets[start_node_idx];
