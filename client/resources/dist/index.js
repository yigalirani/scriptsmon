...
var Terminals = class {
  ...
  command_find() {
    document.body.querySelector('.terms_container .term_panel[style*="display: flex"] .find_widget_container')?.classList.remove("hidden");
  }
  set_selected(id) {
